					...
					<div class="panel-body">
						<div class="row">
							...
							<a class="small-box-footer" href="{{ url('house/quarto') }}">
								<div class="col-lg-3 col-xs-6" style="position:absolute; left:120px; top:280px; width:220px; height:180px;" onMouseOver="this.style.backgroundColor='rgba(255,255,0,0.4)'" onMouseOut="this.style.backgroundColor='transparent'">
								</div>
							</a>
							<a class="small-box-footer" href="{{ url('house/sala') }}">
								<div class="col-lg-3 col-xs-6" style="position:absolute; left:600px; top:150px; width:200px; height:430px;" onMouseOver="this.style.backgroundColor='rgba(255,255,0,0.4)'" onMouseOut="this.style.backgroundColor='transparent'">
								</div>
							</a>
